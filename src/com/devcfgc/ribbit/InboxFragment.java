...
public class InboxFragment extends ListFragment {
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (messageType.equals(ParseConstants.TYPE_IMAGE)) {
			...
			startActivity(intent);
		} else if (messageType.equals(ParseConstants.TYPE_TXT)) {
			// TODO View the txt message
		}
		...
		//Deleting files from parse.com with the rest api
		/*
		  curl -X DELETE \
		  -H "X-Parse-Application-Id: 1RBx5kPNmCbOdRA1jHnjk9KKY4kIcp31N9jebN23" \
		  -H "X-Parse-Master-Key: EXVsF5AyNCDT269J6Rjp2DZg3TIgZan1fDJEU9wK" \
