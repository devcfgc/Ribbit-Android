...
public class RecipientsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTxtMessage = getIntent().getExtras().getString(ParseConstants.KEY_MESSAGE);
	}
	...
	protected ParseObject createMessage() {
		...
		if (mFileType.equals(ParseConstants.TYPE_TXT)) {
			Log.d("FILE TYPE TEST", mTxtMessage);
			message.put(ParseConstants.KEY_MESSAGE, mTxtMessage);
            message.put(ParseConstants.KEY_FILE_TYPE, ParseConstants.KEY_MESSAGE);
			return message;
		}else {
			Log.d("FILE TYPE OTHER", mFileType);
			message.put(ParseConstants.KEY_FILE, mFileType);
